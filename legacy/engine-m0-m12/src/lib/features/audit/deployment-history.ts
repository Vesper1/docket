...
export const buildDeploymentHistory = async (
	root: string,
...
export const writeDeploymentHistory = async (
	directory: string,
...
export const renderDeploymentHistory = (history: DeploymentHistory): string => {
	const lines = [
...
const discoverRunDirectories = async (root: string): Promise<Result<readonly string[], DocketError>> => {
	const found: string[] = [];
