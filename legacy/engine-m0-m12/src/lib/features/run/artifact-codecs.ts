...
export const isDeploymentPlan = (value: unknown): value is DeploymentPlan => {
...
export const isValidationRecord = (value: unknown): value is ValidationRecord => {
...
export const isRunRecord = (value: unknown): value is RunRecord => {
...
export const isDeploymentOutcome = (value: unknown): value is DeploymentOutcome => {
...
const isStepResults = (value: unknown): value is readonly StepResult[] => {
...
const isGateDefinitions = (value: unknown): value is readonly GateDefinition[] => {
	return (
		Array.isArray(value) &&
		value.every((entry) => {
...
const isStepDefinitions = (value: unknown, manualAllowed: boolean): value is readonly StepDefinition[] => {
	return (
		Array.isArray(value) &&
		value.every((entry) => {
...
const isTestSelection = (value: unknown): value is TestSelection => {
...
const verdict = (value: unknown): value is 'passed' | 'failed' => {
