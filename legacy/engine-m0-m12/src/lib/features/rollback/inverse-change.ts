 ...
 */
export const inverseOperations = async (
	cwd: string,
	baseSha: string,
	headSha: string,
	sourceRoot: string,
...
export const operationChange = (operation: RollbackFileOperation): FileChange => {
...
export const publicOperation = (operation: RollbackFileOperation): RollbackOperation => {
