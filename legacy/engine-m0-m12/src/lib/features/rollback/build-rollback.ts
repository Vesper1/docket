...
export const rollbackTargetBranch = async (
 ...
 */
export const buildRollbackProposal = async (
...
const configAt = async (cwd: string, sha: string): Promise<Result<DocketConfig, DocketError>> => {
