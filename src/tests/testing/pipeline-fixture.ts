 ...
 */
export async function createTreeFixture(options: TreeOptions): Promise<PipelineFixture> {
...
export function githubContext(github: FakeGitHub) {
	return { fetch: github.fetch, githubBaseUrl: github.baseUrl };
}

function track(open: PipelineFixture[], fixture: PipelineFixture): PipelineFixture {
	open.push(fixture);
	return fixture;
}
