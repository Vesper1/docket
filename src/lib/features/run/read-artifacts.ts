 ...
 * identity it carries.
 */
export async function readValidatedRun(directory: string): Promise<Result<ValidatedRun, DocketError>> {
...
export async function readValidationRun(directory: string): Promise<Result<ValidatedRun, DocketError>> {
...
export async function readRecordedRun(directory: string): Promise<Result<ValidatedRun, DocketError>> {
...
function tampered(problem: string): DocketError {
