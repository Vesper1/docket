 ...
 */
export function commandNameOf(argv: readonly string[]): string | undefined {
...
function parseOptionsOf(flags: FlagSpecs): Record<string, { type: 'string' | 'boolean'; short?: string }> {
 ...
 */
function optionProblem(error: unknown, command: string | undefined): string {
